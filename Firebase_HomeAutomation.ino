...
#define FIREBASE_HOST "myhomeauto-cd617.firebaseio.com"                     //Your Firebase Project URL goes here without "http:" , "\" and "/"
#define FIREBASE_AUTH "C8CJWvomB9BrpdKIX0hDID2vHG4G8dAeEmzocnDg"       //Your Firebase Database Secret goes here
#define WIFI_SSID "NAK-PTCL-B"                                               //your WiFi SSID for which yout NodeMCU connects
#define WIFI_PASSWORD "xylophone"                                      //Password of your wifi network 
